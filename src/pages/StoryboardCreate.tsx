...
export default function StoryboardCreate() {
  ...
  const generateScript = async () => {
    ...
    try {
      ...
      const enhancedIdea = `${idea || 'أنشئ قصة مناسبة للشخصيات'}. نوع المحتوى: ${genre}. عدد المشاهد: ${sceneCount}. Visual Style: ${style}. Format: ${aspectRatio}. لغة الحوار: ${dialogueLanguage}.`;
      ...
      // Automatically start generating frames
      setProcessingStatus('جاري البدء برسم المشاهد...');
      setStep('frames');
